...
describe PacketFu::ARPPacket do
  context "when initializing ARPPacket" do
    before :each do
      @arp_packet = described_class.new
    end

    it "should have the correct values for initialization" do
      expect(@arp_packet).to be_kind_of(described_class)
    ...
    it "should allow setting values at initialization" do
      ...
      arp = described_class.new(opts_hash)
